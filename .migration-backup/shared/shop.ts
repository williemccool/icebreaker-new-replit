...
export const SHOP_CATALOG: Record<string, ShopItem> = {
  ...
  godmode_monthly: {
    ...
    perks: ["Unlimited swipes", "See who likes you", "Premium rooms", "2× Cubes earning", "Boost once a week"],
  },
  godmode_quarterly: {
  ...
  season_pass: {
    ...
    perks: ["Premium quests track", "2× Cube rewards on quests", "Exclusive Monsoon Nights badge", "Season-end bonus"],
    bestValue: true,
  },
};
