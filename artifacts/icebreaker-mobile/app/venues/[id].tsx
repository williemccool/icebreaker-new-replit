...
const styles = StyleSheet.create({
  ...
  personMeta: { fontSize: 11, fontWeight: "500", marginTop: 2 },
  ...
  roomsBtnText: { fontSize: 13, fontWeight: "700" },
});
