...
const styles = StyleSheet.create({
  ...
  balanceValue: { fontSize: 32, fontWeight: "800", marginTop: 2 },
  ...
  premiumSub: { fontSize: 12, fontWeight: "500", marginTop: 2 },
  ...
  seasonTitle: { fontSize: 15, fontWeight: "800" },
  seasonSub: { fontSize: 12, fontWeight: "500", marginTop: 2 },
  ...
  questSub: { fontSize: 11, fontWeight: "500", marginTop: 2 },
  questReward: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  questRewardText: { fontSize: 12, fontWeight: "800" },
  empty: { fontSize: 13, fontWeight: "500", textAlign: "center", paddingVertical: 20 },
});
