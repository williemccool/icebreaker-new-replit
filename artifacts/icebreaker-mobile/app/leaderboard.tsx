...
const styles = StyleSheet.create({
  ...
  myRankNum: { fontSize: 24, fontWeight: "800" },
  myRankName: { fontSize: 15, fontWeight: "800" },
  myRankXp: { fontSize: 12, fontWeight: "500", marginTop: 2 },
  ...
  entryRank: { width: 24, textAlign: "center", fontSize: 14, fontWeight: "800" },
  entryAvatar: { width: 36, height: 36, borderRadius: 18, alignItems: "center", justifyContent: "center" },
  entryAvatarText: { fontSize: 14, fontWeight: "800" },
  entryName: { fontSize: 14, fontWeight: "700" },
  entryXp: { fontSize: 11, fontWeight: "500", marginTop: 1 },
  empty: { fontSize: 13, fontWeight: "500", textAlign: "center", paddingVertical: 30 },
});
