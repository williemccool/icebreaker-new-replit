...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 12, fontWeight: "600", marginLeft: "auto" },
  ...
  question: { fontSize: 22, fontWeight: "800", marginBottom: 24, lineHeight: 30 },
  options: { gap: 10 },
  ...
  doneSub: { fontSize: 14, fontWeight: "500", textAlign: "center", color: "#8A8FA8" },
