...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: 9, fontWeight: "700", letterSpacing: 1.5, marginTop: 4 },
  ...
  rewardsTitle: { fontSize: 14, fontWeight: "800", marginTop: 2 },
  cubesRow: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 2 },
  cubesText: { fontSize: 12, fontWeight: "700" },
  ...
  linkTitle: { fontSize: 14, fontWeight: "800", marginTop: 8 },
  linkSub: { fontSize: 10, fontWeight: "500", marginTop: 2 },
  ...
  settingsText: { flex: 1, fontSize: 14, fontWeight: "700" },
